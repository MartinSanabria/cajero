...
INSERT INTO cliente(id_cliente, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, telefono, ciudad, departamento)
VALUES(cliente_seq.NextVal, 'Diego', 'Esau', 'Hernandez', 'Maga�a', '7863-3223', 'El Salvador', 'Santa Ana');
INSERT INTO cliente(id_cliente, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, telefono, ciudad, departamento)
...
INSERT INTO cliente(id_cliente, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, telefono, ciudad, departamento)
VALUES(cliente_seq.NextVal, 'Juan', 'Jose', 'Gomes', 'Acu�a', '7122-3239', 'El Salvador', 'Santa Ana');
